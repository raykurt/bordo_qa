...
public class AutomationPracticeRegister {
    ...
    @FindBy(id="phone22")
    public WebElement phoneNumberBox25;

    @FindBy(id="phone_mobile22")
    public WebElement mobileNumberBox25;

    @FindBy(id="submitAccount22")
    public WebElement registerAccountButton45;
